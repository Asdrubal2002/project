...
const Mall = ({ get_categories, categories }) => {
                ...
                <div>
                                                    ...
                                                    if (category.sub_categories.length === 0) {
                                                        return (
                                                            <div key={category.id} className=' flex items-center h-5 my-5'>
                                                                ...
                                                                />
                                                                <label className="ml-3 min-w-0 flex-1 text-gray-100">
                                                                    {category.name}
                                                                </label>
                                                            </div>
                                                        )
                    ...
                    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="relative z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
                            <h1 className="text-4xl font-bold tracking-tight text-color_letra_blanca">Tiendas</h1>
