    ...
    (email, password, re_password) => async (dispatch) => {
        ...
        try {
            ...
            if (res.status === 201) {
                ...
                dispatch(
                    setAlert(
                        "Te enviamos un correo para activar tu cuenta. Revisa el correo de spam",
                        exito
                    )
                );
            } else {
            ...
            setAlert("Error conectando con el servidor, intenta mas tarde.", error);
        }
    };
...
export const login = (email, password) => async (dispatch) => {
    ...
    try {
        ...
        if (res.status === 200) {
            ...
            dispatch(setAlert("Inicio de sesión con éxito.", exito));
        } else {
            dispatch({
                type: LOGIN_FAIL,
            });
